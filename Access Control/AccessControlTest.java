...
/**
 * The class AccessControlTest is used to test the functions of AccessControl class.
...
public class AccessControlTest {
  ...
  /*
   * This test tries to log in with initial admin account with the correct password.
   * Should return true.
   * @return boolean test passed
   */
   ...
   * Log in with the new password. Should return true.
   * @return boolean test passed
   */
  public static boolean testChangePassword() {
    ...
    String user = "admin";
    String pw = "password";
    // Use setCurrentUser method to set admin as logged in. Such that we can change password.
  ...
  /*
   * Create a new AccessControl and log in admin by calling setCurrentUser.
   * First, add a new user. To test the user is successfully added, try to log in the new user.
   * Should return true. If so, continue testing. If not, report a problem.
   * Then remove the new user, and try to log in. This time, it should return false.
   * @return boolean test passed
   */
  public static boolean testRemoveUser() {
    ...
    String user = "user1";
    String pw = "changeme";
    // Use setCurrentUser method to set admin as logged in. Such that we can add and remove user.
    ac.setCurrentUser(admin);
    ac.addUser(user);
    // We should first ensure new user is successfully added, try to log in the new user.
  ...
  /*
   * Create a new AccessControl and log in admin by calling setCurrentUser. Reset the password.
   * Try to log in the admin with the DEFAULT_PASSWORD, which is "changeme". Should return true.
   * @return boolean test passed
   */
  public static boolean testResetPassword() {
    ...
    String user = "admin";
    String pw = "changeme";
    // Use setCurrentUser method to set admin as logged in. Such that we can reset the password.
    ac.setCurrentUser(user);
