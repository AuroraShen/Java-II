...
/**
 * This class is a driver class of the ASCII Art application. It displays the menu
 * for user and take the user input as command for the application. The processcommand 
 * method process the instructions from the user.
 */

import java.util.Scanner;

/**
 * This class provides the interface for user to create a canvas and make different operations
 * to the canvas, for example like create a canvas, draw something on the canvas, undo and redo
 * drawing etc.
 */
public class AsciiArt {
  ...
  /**
   * This method input users command and process the command to modify the canvas. Base
   * on the command, the application is able to create a canvas, draw a character, undo
   * or redo the drawing, show the canvas and show the drawing history.
   * @param command the user command
   * @return true if the user does not command to quit the application
   *         false if the user input 7 (exit command)
   */
  ...
  /**
   * The main method of the Ascii Art class that calls other driver method
   * to implement the application. The method begins with a driver loop.
   * 
   * @param args
   */
