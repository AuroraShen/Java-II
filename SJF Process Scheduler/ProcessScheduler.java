...
public class ProcessScheduler {
  ...
  /**
   * set up the CustomProcessQueue queue, initialize both currentTime and numProcessRun to zero
   */
  ...
  /**
   * When it is called, the run() method starts running the ready processes already scheduled 
   * in the queue according to the SJF scheduling policy. This method returns when all the 
   * scheduled processes are run and the queue is empty. It returns a String that represents 
   * the log of one run operation.
   * 
   ...
   * @return true if application not end after the execution of the command, false otherwise
   */
   ...
   * This method creates and uses only one instance of the Scanner class,
