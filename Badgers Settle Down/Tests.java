...
/**
 * The class is used to test the functions of Badger and Sett class.
...
public class P9Tests {
  ...
  private static boolean testGetAllBadgers(){
    ...
    if (allBadgers.get(0).getSize() != 1 || allBadgers.get(1).getSize() != 3 
        || allBadgers.get(2).getSize() != 5 || allBadgers.get(3).getSize() != 7 
        || allBadgers.get(4).getSize() != 9) // array should contain exactly these elements
      return false;
    return true;
  }
